...
<template>
    ...
    <div class="relative flex min-h-screen flex-col items-center overflow-hidden bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        <img
            src="/images/bg.svg"
            alt=""
            aria-hidden="true"
        ...
        />
        <div class="absolute inset-0 bg-white/30 dark:bg-black/40" />
        <div class="relative flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
